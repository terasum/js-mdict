...
var _Mdict = require("./Mdict");

var _Mdict2 = _interopRequireDefault(_Mdict);
...
const dictPath = _path2.default.join(__dirname, "../resource/Collins.mdx");
...
const mdict = new _Mdict2.default(dictPath);
