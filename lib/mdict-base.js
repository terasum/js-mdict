...
var MDictBase = function () {
  ...
  _createClass(MDictBase, [{
    ...
    value: function _readHeader() {
      ...
      this.compareFn = _common2.default.isTrue(this.header.KeyCaseSensitive) || this.ext === 'mdd' ? _common2.default.normalUpperCaseWordCompare : _common2.default.wordCompare;
