...
var MDictBase = function () {
  ...
  _createClass(MDictBase, [{
    ...
    value: function _decodeKeyBlockInfo(keyBlockInfoBuff) {
      ...
      (0, _assert2.default)(countEntriesNum === num_entries, "the number_entries should equal the count_num_entries");
    ...
    value: function _reduceWordKeyBlock(phrase, _s) {
      ...
      while (left <= right) {
        ...
        if (_common2.default.wordCompare(_s(phrase), _s(this.keyBlockInfoList[mid].firstKey)) >= 0 && _common2.default.wordCompare(_s(phrase), _s(this.keyBlockInfoList[mid].lastKey)) <= 0) {
          return mid;
        } else if (_common2.default.wordCompare(_s(phrase), _s(this.keyBlockInfoList[mid].lastKey)) >= 0) {
          left = mid + 1;
        } else {
          right = mid - 1;
        }
