  ...
  _createClass(MDictBase, [{
    ...
    value: function _reduceWordKeyBlock(phrase, _s) {
      ...
      while (left <= right) {
        ...
        if (_s(phrase) >= _s(this.keyBlockInfoList[mid].firstKey) && _s(phrase) <= _s(this.keyBlockInfoList[mid].lastKey)) {
          return mid;
    ...
    value: function _decodeRecordBlockByRBID(rbid, keyText, start, nextStart) {
      ...
      return { keyText: keyText, recordStartOffset: start, definition: this._decoder.decode(data) };
    }
  }, {
    key: "_readBuffer",
