...
var MDict = function () {
  ...
  _createClass(MDict, [{
    ...
    value: function _readHeader() {
      ...
      // parse header info
      this.header_info = _common2.default.parseHeader(header_text);
    ...
    value: function _readkeyHeader() {
      ...
      var num_bytes = this._version >= 2.0 ? 8 * 5 : 4 * 4;
      ...
      this.keyHeader.keyBlocksNum = this.__readnumber(key_info_b.slice(tmp_ofset, key_i_ofst + this._number_width));
      key_i_ofst += this._number_width;
      // console.log("num_key_blocks", num_key_blocks.toString());


      // number of entries
      this.keyHeader.entriesNum = this.__readnumber(key_info_b.slice(key_i_ofst, key_i_ofst + this._number_width));
      key_i_ofst += this._number_width;
    ...
    value: function _decode_key_block(key_block_compressed, key_block_info_list) {
      ...
      for (var idx = 0; idx < key_block_info_list.length; idx++) {
        ...
        var splitedKey = this._split_key_block(new _bl2.default(key_block), this._number_format, this._number_width, this._encoding);
