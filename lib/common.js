...
function mdxDecrypt(comp_block) {
  var key = _ripemd2.default.ripemd128(new _bl2.default(comp_block.slice(4, 8)).append(Buffer.from([0x95, 0x36, 0x00, 0x00])).slice(0, 8));
  return new _bl2.default(comp_block.slice(0, 8)).append(fast_decrypt(comp_block.slice(8), key));
}
