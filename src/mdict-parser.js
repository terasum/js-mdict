...
var ln = require("@everymundo/linenumber").linenumber;
...
// }(this, function(pako, lzo, ripemd128, Promise, parseXml, common) {
  ...
  function decrypt(buf, bkey) {
    var key = ripemd128.ripemd128(bkey);
...
//        scanner.readNum(); scanner.readText();
    ...
    function findWord(keyinfo) {
      ...
      // console.log("[old] mdict-parser.js:683", block)
